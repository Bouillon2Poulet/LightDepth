...
public class Generation3D : MonoBehaviour
{
    ...
    public void generate3DModel()
    {
        ...
        voxels.Clear();
        Texture2D colorTexture = SaveManager.GetComponent<SavingToolManager>().finalColorTexture;
        Texture2D heightTexture = SaveManager.GetComponent<SavingToolManager>().finalHeightTexture;
